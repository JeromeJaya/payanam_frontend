...
import PlaceHeader from "./components/explore/PlaceHeader";
import PlaceHighlights from "./components/explore/PlaceHighlights";
import PlaceBookingCard from "./components/explore/PlaceBookingCard";
...
export default function ExploreDestinations() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      <PlaceHighlights getAnimationClass={getAnimationClass} />
