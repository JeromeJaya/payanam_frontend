  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 mb-4">
      <div className="flex items-center gap-2 mb-3">
        <h3 className="text-md font-bold text-gray-900">Important Information</h3>
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-start gap-2 mb-2">
            ...
            <h4 className="text-md font-semibold text-gray-900">Check travel guidelines and baggage information below:</h4>
          </div>
          <ul className="space-y-1.5 ml-6">
            <li className="text-md text-gray-700 list-disc">
        ...
        <div>
          <div className="flex items-start gap-2 mb-2">
            ...
            <h4 className="text-md font-semibold text-gray-900">Availability of Boarding Pass:</h4>
          </div>
          <p className="text-md text-gray-700 ml-6">
        ...
        <div>
          <div className="flex items-start gap-2 mb-2">
            ...
            <h4 className="text-md font-semibold text-gray-900">Unaccompanied Minors Travelling:</h4>
          </div>
          <ul className="space-y-1.5 ml-6">
            <li className="text-md text-gray-700 list-disc">
